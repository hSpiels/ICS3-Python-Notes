...
def inflate(actorIn, xIncrease, yIncrease):
    ...
    '''
        ...
        actorIn._surf = pygame.transform.scale(actorIn._surf, (currentXSize + xIncrease, currentXSize + xIncrease)) #Scale the actor to a new height and width
